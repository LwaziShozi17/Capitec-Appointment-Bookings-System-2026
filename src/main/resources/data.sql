...
SELECT setval(pg_get_serial_sequence('appointment_slots', 'id'), COALESCE(MAX(id), 1)) FROM appointment_slots;
SELECT setval(pg_get_serial_sequence('appointments', 'id'), COALESCE(MAX(id), 1)) FROM appointments;
SELECT setval(pg_get_serial_sequence('operating_hours', 'id'), COALESCE(MAX(id), 1)) FROM operating_hours;
